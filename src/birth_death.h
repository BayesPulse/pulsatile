...
// DESCRIPTION: Function definitions for birthdeath_strauss.c
// 

#ifndef BIRTH_DEATH_H
#define BIRTH_DEATH_H
...
double *calc_death_rate_strauss(Node_type *list, int num_node, 
                                double *partial_likelihood, 
                                double full_likelihood, double birth_rate,
                                double pulse_intensity, Priors *priors);
